...
from src.infrastructure.db.postgres.repositories import PostgresMarketplacesRepositoryImplement
...
def setup_ioc(container: container) -> None:
    ...
    container.register(
        abstract_class=PostgresMarketplacesRepositoryInterface,
        concrete_class=PostgresMarketplacesRepositoryImplement
    )
    container.register(
