...
class PostgresSKUUploadDataDTO(BaseModel):
    ...
    product_id: str = Field(..., description="id товара в маркетплейсе")
    ...
    features: Optional[dict] = Field(None, description="Характеристики товара")
    ...
    inserted_at: datetime = Field(default_factory=datetime.utcnow, description="Дата вставки")
